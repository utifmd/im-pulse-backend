...
interface IFileService {
    ...
    /*suspend fun uploadFile(filePartData: MultiPartData, compress: Boolean): FileResponse
    suspend fun uploadImageFile(filePartData: MultiPartData): List<FileResponse>*/
}